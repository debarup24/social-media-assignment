...
const StoryCards = () => {
  return (
    <div className="flex flex-row md:flex md:flex-row lg:flex-row w-screen md:w-[800px] md:m-auto gap-2.5 p-1 md:p-3 items-center justify-center overflow-x-auto no-scrollbar">
      {/* cards comp */}
      <div className="h-36 w-24 bg-gray-500 relative cursor-pointer rounded-xl flex items-center justify-center">
        <p className="text-gray-100 font-base text-sm text-center opacity-60">
          + add story
        </p>
      </div>

      <img
        className="h-36  w-24 relative cursor-pointer rounded-xl "
